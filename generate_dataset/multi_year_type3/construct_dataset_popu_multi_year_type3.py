...
f"""Imagine you are studying urban change using geospatial data. The dataset includes {used_year_num} yearly snapshots of a region, from {all_years[0]} through {all_years[-1]}. The images are provided to you as per the instructions below. Each yearâ€™s available imagery is described below:""",
...
Year {year}:
    - Images provided: {image_description}
                ...
                if city_name == 'HELSINKI':
                    sat_image_path = '../../download_sat/outputs/' + f'downloaded_sat_{year}_zoom_{16}/urbancore/{year}-07-31/urbancore/{16}/{sat_image_row}/{sat_image}'
