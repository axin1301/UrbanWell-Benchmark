...
#     output_dir = "outputs/generated_NO2/"+city_name
...
#         # if os.path.exists(os.path.join(output_dir, f"/{city_name}_NO2_{year}.csv")):
#         #     continue
        
#         # if year == 2017:
#         #     tif_path = f"outputs/eea_raw_data/EEA/\eea_r_3035_1_km_aq-interpolated-NO2_p_2017_v01_r00/eea_r_3035_1_km_aq-interpolated-NO2_p_2017_v01_r00/EEA_1kmgrid_2017_no2_avg.tif"
#         # elif year == 2021:
#         #     tif_path = tif_path = f"outputs/eea_raw_data/EEA/\eea_r_3035_1_km_aq-interpolated-no2_p_2021_v01_r00/eea_r_3035_1_km_aq-interpolated-no2_p_2021_v01_r00/EEA_1kmgrid_2021_no2_avg.tif"
#         # elif year == 2024:
#         #     tif_path = f"outputs/eea_raw_data/EEA/\eea_r_3035_1_km_aq-interpolated-no2_p_2024_v00_r00/eea_r_3035_1_km_aq-interpolated-no2_p_2024_v00_r00/no2_avg24_int.tif"

#         tif_path_list = glob.glob(f"outputs/eea_raw_data/EEA/\eea_r_3035_1_km_aq-interpolated-NO2_p_{year}_v*/eea_r_3035_1_km_aq-interpolated-NO2_p_{year}_v*/*.tif")
...
#         df_out.to_csv(output_dir + f"/{city_name}_NO2_{year}.csv", index=False)
...
for city_name in tqdm.tqdm(city_list):
    ...
    for year in [2017,2021,2024]:
        ...
        date = f"{year_str}-07-31"
        zoom_level = 16
        identifier = city_name #'urbancore'
